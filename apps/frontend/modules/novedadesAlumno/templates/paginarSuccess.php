...
<form action="<?php echo url_for('novedadesAlumno/search') ?>" class="form-horizontal" role="form">
	...
	<?php endforeach; ?>		
    <input type="submit" value="Buscar" class="btn btn-info col-sm-offset-2"></input>	
</form>
<form action="<?php echo url_for('novedadesAlumno/test') ?>">    
