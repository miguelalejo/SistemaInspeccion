...
FOR %%x IN ("C:\PHP\Desarrollo\SistemaInspeccion\pear-php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\PHP\Desarrollo\SistemaInspeccion\pear-php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\PHP\Desarrollo\SistemaInspeccion\pear-php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\wamp\bin\php\php5.3.13\php.exe"
