...
class sfValidatorFileImage extends sfValidatorFile
{
  ...
  protected function configure($options = array(), $messages = array())
  {
    ...
    $this->addMessage('invalid_image', '%value% no es un formato valido para una imagen.');
    $this->addMessage('max_height', '"%value%" el alto es muy grande, el valor maximo es (%max_height% pixeles).');
    $this->addMessage('min_height', '"%value%" el alto es muy pequeño, el valor minimo es (%min_height% pixeles).');
    $this->addMessage('max_width', '"%value%" el ancho es muy grande, el valor maximo es (%max_width% pixeles).');
    $this->addMessage('min_width', '"%value%" el ancho es muy pequeño, el valor minimo es (%min_width% pixeles).');
